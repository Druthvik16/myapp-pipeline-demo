...
@Component({
  selector: 'app-uploaded-preview',
  standalone: false,
  templateUrl: './uploaded-preview.component.html',
  styleUrl: './uploaded-preview.component.scss',
})
export class UploadedPreviewComponent {
  ...
  processingType: 'save' | 'reject' | null = null;
  fullData: any[] = [];
  rowHeight = 40;
  viewportHeight = 600;
  buffer = 50;
  ...
  defaultColDef: any = {
    ...
    cellClassRules: {},
    cellStyle: undefined,
    headerTooltip: (params: any) => params.colDef && params.colDef.headerName ? params.colDef.headerName : '',
  };
